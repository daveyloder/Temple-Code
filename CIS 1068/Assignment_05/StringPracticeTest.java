...
public class StringPracticeTest extends StringPractice {
    ...
    public void testNumPunctAfterNonPunct() {
        assertEquals(null, 2, StringPractice.numPunctAfterNonPunct(" ! !"), 0);
        assertEquals(null, 3, StringPractice.numPunctAfterNonPunct("I cannot spell, or use. Punctuation..."), 0);
        assertEquals(null, 0, StringPractice.numPunctAfterNonPunct("!!!!!!!!"), 0);
        assertEquals(null, 4, StringPractice.numPunctAfterNonPunct("!! !  ! !! 1 !"), 0);
