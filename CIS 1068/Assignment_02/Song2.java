...
public class Song2 {
    // Create verse end string variable
    static String verseends = "";

    // Function to print cat verse
    public static void cat(String[] args) {
        System.out.print("Bought me a cat and the cat pleased me,\r\n" + //
                "I fed my cat under yonder tree.\r\n");
        // Adds cat verse to the verseends variable and adds to the begining of
        // variable.
    ...
    public static void hen(String[] args) {
        ...
        // Appends new verse to begining of string.
    ...
    public static void wendigo(String[] args) {
        System.out.print("Bought me a wendigo and the wen... wait a minute.\r\n" + //
                ...
                "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%..%/...%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\r\n" + //
                "%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%\r\n");
        System.out.print(" ___       __   _______   ________   ________  ___  ________  ________     \r\n" + //
                "|\\  \\     |\\  \\|\\  ___ \\ |\\   ___  \\|\\   ___ \\|\\  \\|\\   ____\\|\\   __  \\    \r\n" + //
                "\\ \\  \\    \\ \\  \\ \\   __/|\\ \\  \\\\ \\  \\ \\  \\_|\\ \\ \\  \\ \\  \\___|\\ \\  \\|\\  \\   \r\n"
                + //
                " \\ \\  \\  __\\ \\  \\ \\  \\_|/_\\ \\  \\\\ \\  \\ \\  \\ \\\\ \\ \\  \\ \\  \\  __\\ \\  \\\\\\  \\  \r\n"
                ...
                "  \\ \\  \\|\\__\\_\\  \\ \\  \\_|\\ \\ \\  \\\\ \\  \\ \\  \\_\\\\ \\ \\  \\ \\  \\|\\  \\ \\  \\\\\\  \\ \r\n"
                + //
                "   \\ \\____________\\ \\_______\\ \\__\\\\ \\__\\ \\_______\\ \\__\\ \\_______\\ \\_______\\\r\n" + //
                "    \\|____________|\\|_______|\\|__| \\|__|\\|_______|\\|__|\\|_______|\\|_______|\r\n" + //
                " ________  _________  _________  ________  ________  ___  __               \r\n" + //
