...
public class TestHand {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(hand.getRankFrequency().entrySet().toArray())); // format: [4=1, 8=1, 9=1,
                                                                                           // 10=1, 13=1]
        ...
        System.out.print("Card ranks:" + Arrays.toString(new Hand("7S 8S 9S JS TH").getCardRanks())); // [11, 10, 9, 8,
                                                                                                      // 7]
